...
#include <android/asset_manager.h> // Include if not already
...
void initWalker(AAssetManager* assetManager); // Must be called once before the main loop
...
void setAccelerometer(int8_t x, int8_t y, int8_t z); // Not used yet